            ...
            if action == "setup":
                ...
                return {
                    ...
                    "steps": [
                        ...
                        f"3. Run: nmem_sync_config(action='set', hub_url='{DEFAULT_HUB_URL}', api_key='nmk_YOUR_KEY')",
                        "4. Run: nmem_sync(action='seed') to prepare existing memories",
                        "5. Run: nmem_sync(action='push') to upload to cloud",
                    ],
